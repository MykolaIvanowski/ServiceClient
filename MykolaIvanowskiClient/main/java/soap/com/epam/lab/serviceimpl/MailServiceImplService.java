 ...
 * 
 */
@WebServiceClient(name = "MailServiceImplService", targetNamespace = "http://serviceimpl.lab.epam.com.soap.java.main/", wsdlLocation = "http://localhost:8080/MailService/MailService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MAILSERVICEIMPLSERVICE_QNAME = new QName("http://serviceimpl.lab.epam.com.soap.java.main/", "MailServiceImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/MailService/MailService?wsdl");
    ...
    public MailService getMailServiceImplPort() {
        return super.getPort(new QName("http://serviceimpl.lab.epam.com.soap.java.main/", "MailServiceImplPort"), MailService.class);
    }
    ...
    public MailService getMailServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serviceimpl.lab.epam.com.soap.java.main/", "MailServiceImplPort"), MailService.class, features);
    }
