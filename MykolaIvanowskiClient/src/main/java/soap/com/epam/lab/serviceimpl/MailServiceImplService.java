 ...
 * 
 */
@WebServiceClient(name = "MailServiceImplService", targetNamespace = "http://serviceimpl.lab.epam.com.soap/", wsdlLocation = "http://localhost:8080/MailService/MailService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MAILSERVICEIMPLSERVICE_QNAME = new QName("http://serviceimpl.lab.epam.com.soap/", "MailServiceImplService");
    ...
    public MailService getMailServiceImplPort() {
        return super.getPort(new QName("http://serviceimpl.lab.epam.com.soap/", "MailServiceImplPort"), MailService.class);
    }
    ...
    public MailService getMailServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://serviceimpl.lab.epam.com.soap/", "MailServiceImplPort"), MailService.class, features);
    }
